...
function getTimerEnd(): number {
  ...
  const startSeconds = Math.floor(Math.random() * (14 * 60 + 48 - 14 * 60 + 12 + 1)) + 14 * 60 + 12;
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center">
      <div className="w-full max-w-md px-4 pb-20">
        {/* Timer banner */}
        <div className="w-full bg-red-500 text-white text-center py-2 text-sm font-semibold">
          ⏱ Offer expires in: <span className="font-bold tabular-nums">{formatTime(timeLeft)}</span>
        </div>
        ...
        <div className="mt-6 flex justify-center">
          <img
            ...
            className="w-72 max-w-full rounded-2xl shadow-2xl"
          />
        </div>
        ...
        <div className="mt-7 flex justify-center">
          <a
            ...
            className="pulse-btn block w-full bg-orange-500 hover:bg-orange-600 active:bg-orange-700 text-white font-bold text-xl py-5 rounded-2xl shadow-xl text-center transition-colors"
          >
            Claim My $750 Now →
          </a>
        </div>
        ...
        <div className="mt-6 text-center">
          ...
          <div className="mt-3 flex justify-center gap-4 text-xs text-orange-500 font-medium">
...
function Step({ number, title, subtitle }: { number: number; title: string; subtitle: string }) {
  return (
    <div className="flex items-start gap-4 bg-gray-50 rounded-2xl px-5 py-4">
      <div className="w-9 h-9 rounded-full bg-orange-500 text-white font-bold text-base flex items-center justify-center flex-shrink-0">
        {number}
      </div>
      <div>
